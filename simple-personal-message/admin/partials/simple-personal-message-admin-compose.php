        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form action="" id="frm-compose" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="txt-sender" id="txt-sender" value="<?php echo wp_get_current_user()->user_login; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="txt-receiver" id="txt-receiver" value="<?php echo isset($sender) ? $sender : '' ?>" placeholder="Type to get user name suggestion (Multiple user allowed)">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="txt-subject" id="txt-subject" value="<?php echo isset($subject) ? $subject : '' ?>" placeholder="Type a relevant Subject line">
            ...
            <div class="panel-footer">
                ...
                <a href="javascript:void(0)" id="btn-send-message" class="btn btn-primary btn-block">Send Message</a>
