...
class Simple_Personal_Message_Admin
{
    ...
    public function add_plugin_admin_menu()
    {
        ...
        add_options_page(
            ...
            'Message Settings', // Top Level Menu
        ...
        add_menu_page(
            ...
            'FADA Message ' . '<span class="update-plugins"><span class="plugin-count">' . $this->unread_count() . '</span></span>',
        ...
        add_submenu_page(
            ...
            'Inbox ' . '<span class="update-plugins"><span class="plugin-count">' . $this->unread_count() . '</span></span>',
        ...
        register_taxonomy(
            ...
            array(
                ...
                'labels' => array(
                    ...
                    'name' => __('Message User Groups', $this->plugin_name),

                    'singular_name' => __('Message Group', $this->plugin_name),

                    'menu_name' => __('Message User Groups', $this->plugin_name),

                    'search_items' => __('Search Message Groups', $this->plugin_name),

                    'popular_items' => __('Popular Message Groups', $this->plugin_name),

                    'all_items' => __('All Message User Groups', $this->plugin_name),

                    'edit_item' => __('Edit Message User Group', $this->plugin_name),

                    'update_item' => __('Update Message User Group', $this->plugin_name),

                    'add_new_item' => __('Add Message User Group', $this->plugin_name),

                    'new_item_name' => __('New User Group Name', $this->plugin_name),

                    'separate_items_with_commas' => __('Separate Message user groups with commas', $this->plugin_name),

                    'add_or_remove_items' => __('Add or remove Message user groups', $this->plugin_name),

                    'choose_from_most_used' => __('Choose from the most popular Message user groups', $this->plugin_name),
    ...
    public function add_user_group_into_profile($user)
    {
        ...
        echo "<h3>Message User Groups</h3>";
    ...
    public function set_spm_group_user_column($column)
    {
        ...
        $column['spm-user-group'] = 'Message Group';
