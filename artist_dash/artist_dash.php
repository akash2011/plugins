<?php
/*
Plugin Name: FADA Artist Dashboard Widget
Plugin URI: http://codex.wordpress.com/Example_Dashboard_Widget
Description: FADA add artist from Dashboard 
Version: 1.0
Author: ashraful kabir(sky)
Author URI: http://pulse-creative.com/
License: GPLv2 or later
*/
add_action('wp_dashboard_setup', array('Artist_Dashboard_Widget','init') );

class Artist_Dashboard_Widget {

    /**
     * The id of this widget.
     */
    const wid = 'artist_widget_example';
    ...
    public static function init() {
        ...
        wp_add_dashboard_widget(
            ...
            __( 'Artist', 'nouveau' ),//Visible name for the widget
            array('Artist_Dashboard_Widget','widget'),      //Callback for the main widget content
            array('Artist_Dashboard_Widget','config')       //Optional callback for widget configuration content
        );
    }
